...
if (!function_exists('car_booking_payment_success')) {
    /**
     * @param $data
     * @return void
     */
    function car_booking_payment_success($data): void
    {
        PaymentResponse::carBookingPaymentSuccess($data);
    }
}

if (!function_exists('car_booking_payment_fail')) {
    /**
     * @param $data
     * @return void
     */
    function car_booking_payment_fail($data): void
    {
        //
    }
}
