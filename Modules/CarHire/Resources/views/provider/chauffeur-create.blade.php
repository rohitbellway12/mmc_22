                ...
                <div class="card-body">
                    <form action="{{ route('provider.car.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="category_id"
                            value="{{ $categories->firstWhere('name', 'Chauffeur')?->id ?? ($categories->firstWhere('name', 'Chauffeur Service')?->id ?? 'fd6a04cf-3803-4a9b-a830-6cfa9c3c48d4') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="car_type_id" class="form-control" required>
                                        <option value="" disabled selected>{{ translate('Select Car Type') }}</option>
