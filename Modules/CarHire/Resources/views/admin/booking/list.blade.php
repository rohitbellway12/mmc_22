                                    ...
                                    <tbody>
                                        @forelse($bookings as $key => $booking)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.car.booking.details', [$booking->id]) }}">
                                                        {{ $booking->id }}
                                                    </a>
                                                </td>
                                                <td>
                                                    @if ($booking->car && $booking->car->provider)
                                                        {{ $booking->car->provider->company_name }}<br>
                                                        {{ $booking->car->provider->company_phone }}
                                                    @else
                                                        {{ translate('N/A') }}
                                                    @endif
                                                </td>
                                        ...
                                        @empty
                                            <tr class="text-center">
                                                <td colspan="11">{{ translate('No_bookings_found') }}</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
