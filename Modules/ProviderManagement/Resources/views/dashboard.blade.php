...
@section('content')
                                    ...
                                    <ul class="option-select-btn">
                                        <li>
                                            <label>
                                                ...
                                                <span
                                                    class="d-flex align-items-center border shadow-none h-36">{{ translate('Yearly') }}</span>
                                            </label>
                                        </li>
                                    </ul>
                        ...
                        <div class="card-body">
                            ...
                            @if (isset($data[6]['recent_transactions']) && count($data[6]['recent_transactions']) > 0)
                                <div class="d-flex align-items-center gap-3 mb-4">
                                    <img src="{{ asset('public/assets/provider-module') }}/img/icons/arrow-up.png"
                                        alt="">
                                ...
                                @foreach ($data[4]['subscriptions'] as $key => $subscription)
                                    <li
                                        ...
                                        <div class="media gap-10">
                                            <div class="avatar avatar-lg">
                                                <img class="avatar-img rounded"
                                                    src="{{ $subscription->image_full_path ?? '' }}" alt="">
                                            </div>
                                            <div class="media-body">
    ...
    <!-- Guidline Offcanvas -->
    <div class="offcanvas offcanvas-cus-sm offcanvas-end" tabindex="-1" id="offcanvasSetupGuide"
        aria-labelledby="offcanvasSetupGuideLabel">
            ...
            <div class="py-3 px-3 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-3 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-3 align-items-center bg-transparent border-0 p-0"
                        type="button" data-bs-toggle="collapse" data-bs-target="#collapseGeneralSetup_01"
                        aria-expanded="true">
                        <div
                            class="btn-collapse-icon d-flex align-items-center justify-content-center border icon-btn rounded-circle fs-12 lh-1">
            ...
            <div class="p-12 p-sm-20 bg-light rounded mb-3 mb-sm-20">
                <div class="d-flex gap-3 align-items-center justify-content-between overflow-hidden">
                    <button class="btn-collapse d-flex gap-3 align-items-center bg-transparent border-0 p-0 collapsed"
                        type="button" data-bs-toggle="collapse" data-bs-target="#collapseGeneralSetup_02"
                        aria-expanded="true">
                        <div
                            class="btn-collapse-icon d-flex align-items-center justify-content-center border icon-btn rounded-circle fs-12 lh-1 collapsed">
                            <i class="fi fi-rr-angle-up"></i>
                        </div>
            ...
            <div class="modal-content modal-content_cont rounded-3 overflow-visible">
                ...
                <div class="modal-body">
                    <div class="modal-instruction-content  position-absolute top-0">
                        <img class="mb-3" src="{{ asset('public/assets/admin-module/img/modal-arrow.svg') }}"
                            alt="">
                        ...
                        <div class="p-20 bg-light rounded">
                            <div class="d-flex align-items-center gap-2">
                                <div class="d-flex gap-1 align-items-center">
                                    ...
                                    <label class="user-select-none flex-grow-1" for="Information">Business
                                        Information</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-20 bg-light rounded">
                            <div class="d-flex align-items-center gap-2">
                                <div class="d-flex gap-1 align-items-center">
                                    ...
                                    <label class="user-select-none flex-grow-1" for="Availability">Service Availability &
                                        Bookings</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-bs-dismiss="modal" aria-label="Close" class="">
                        <a class="btn btn--primary rounded px-3 d-flex align-items-center gap-1 btn-sm position-absolute end-40 bottom-20"
                            href="#0">
