...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    Route::group(['prefix' => 'provider', 'as' => 'provider.'], function () {
        ...
        Route::group(['prefix' => 'category-questions', 'as' => 'category_questions.'], function () {
...
Route::group(['prefix' => 'provider', 'as' => 'provider.', 'namespace' => 'Web\Provider', 'middleware' => ['provider']], function () {
    ...
    Route::group(['prefix' => 'settings', 'as' => 'settings.'], function () {
        Route::get('terms-conditions', 'ProviderController@termsAndConditions')->name('terms-conditions');
        Route::post('terms-conditions', 'ProviderController@updateTermsAndConditions');
        Route::get('about-us', 'ProviderController@aboutUs')->name('about-us');
        Route::post('about-us', 'ProviderController@updateAboutUs');
    });
    ...
    Route::group(['prefix' => 'service-pricing', 'as' => 'service_pricing.'], function () {
        Route::get('/', 'ProviderServicePriceController@index')->name('index');
        Route::post('/', 'ProviderServicePriceController@store')->name('store');
        Route::post('/bulk-update', 'ProviderServicePriceController@bulkUpdate')->name('bulk_update');
        Route::put('/status', 'ProviderServicePriceController@updateStatus')->name('update_status');
        Route::delete('/{id}', 'ProviderServicePriceController@destroy')->name('destroy');
    });

    Route::group(['prefix' => 'time-slots', 'as' => 'time_slots.'], function () {
        Route::get('/', 'ProviderTimeSlotController@index')->name('index');
        Route::post('/', 'ProviderTimeSlotController@store')->name('store');
        Route::put('/status', 'ProviderTimeSlotController@updateStatus')->name('update_status');
        Route::delete('/{id}', 'ProviderTimeSlotController@destroy')->name('destroy');
    });

    //    Route::group(['prefix' => 'custom-questions', 'as' => 'custom_questions.'], function () {
//        Route::get('/', 'ProviderQuestionController@index')->name('index');
//        Route::post('/', 'ProviderQuestionController@store')->name('store');
//        Route::put('/status', 'ProviderQuestionController@updateStatus')->name('update_status');
//        Route::delete('/{id}', 'ProviderQuestionController@destroy')->name('destroy');
//    });
