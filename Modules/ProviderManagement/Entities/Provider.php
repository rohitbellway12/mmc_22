...
class Provider extends Model
{
    ...
    {
        return $this->hasMany(ProviderServicePrice::class, 'provider_id');
    }

    public function timeSlots(): HasMany
    {
        return $this->hasMany(ProviderTimeSlot::class, 'provider_id');
    }

    public function customQuestions(): HasMany
    {
        return $this->hasMany(ProviderQuestion::class, 'provider_id');
    }
