...
class SubscribedService extends Model
{
    ...
    protected $casts = [
        ...
        'service_types' => 'array',
        'service_price' => 'float',
        'completed_service_images' => 'array',
    ];

    protected $fillable = ['provider_id', 'category_id', 'sub_category_id', 'service_id', 'is_subscribed', 'service_capabilities', 'estimated_time', 'service_types', 'service_price', 'completed_service_images'];
