...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Web\Admin', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
        ...
        Route::put('set-business-model-setup', 'BusinessInformationController@businessModelSetup')->name('set-business-model-setup');
       ...
       // Route::post('set-pages-setup', 'BusinessInformationController@pagesSetupSet')->name('set-pages-setup')
        ...
        Route::get('delete-database-backup/{file_name}', [BusinessInformationController::class, 'deleteDatabaseBackup'])
            ->where('file_name', '.*')
