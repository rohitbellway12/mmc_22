                        ...
                        <div class="bg-primary d-flex align-items-center rounded-2 p-20 bg-opacity-10 mb-20">
                            <div class="boxes">
                                ...
                                <ul class="d-flex flex-column gap-2 px-3 mb-0">
                                    <li class="fz-12">
                                        {{translate('Upload file must be  JPEG, JPG, GIF, PNG, WBEP file format in and click save information.')}}
                                    </li>
                                    <li class="fz-12">
                                        {{translate('Uploaded file total size maximum 128 MB')}}
                                    </li>
                                    <li class="fz-12">
                        ...
                        <div>
                            ...
                            <div class="body-bg rounded p-20 mb-20">
                                ...
                                <div class="trigger-image-hit ratio-1 position-relative max-w-100 overflow-hidden bg-white border-dashed rounded-2 mx-auto h-100px d-center">
                                    <input type="file" name="images[]" multiple accept="image/*" required style="position: absolute; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                    ...
                    <div class="discount-type mb-20">
                        <div class="bg-primary d-flex align-items-center rounded-2 p-20 bg-opacity-10 mb-20">
                            <div class="boxes">
                                ...
                                <ul class="d-flex flex-column gap-2 px-3 mb-0">
                                    <li class="fz-12">
                                        {{translate('Upload file must be  ZIP file format in and click save information.')}}
                                    </li>
                                    <li class="fz-12">
                                        {{translate('Uploaded file total size maximum 128 MB')}}
                                    </li>
                        ...
                        <div>
                            ...
                            <div class="body-bg rounded p-20 mb-20">
                                ...
                                <div class="trigger-zip-hit ratio-1 position-relative max-w-100 overflow-hidden bg-white border-dashed rounded-2 mx-auto h-100px d-center">
                                    <input type="file" name="file" accept=".zip" required style="position: absolute; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                                    <div class="global-upload-box">
                                        <div class="upload-content text-center">
