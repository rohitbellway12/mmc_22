                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-xxl-3 col-md-4">
                                                        <div class="card2 rounded p-20 mb-15">
                                                            ...
                                                            <p class="fz-12 mt-2 text-center">{{ translate('JPG, JPEG, PNG, Gif Image size : Max 2 MB') }} <span class="fw-medium text-dark">(3:1)</span></p>
                                                        </div>
                                                        <div class="card2 rounded p-20">
                                                            ...
                                                            <p class="fz-12 mt-2 text-center">{{ translate('JPG, JPEG, PNG, Gif Image size : Max 2 MB') }} <span class="fw-medium text-dark">(1:1)</span></p>
                                                        </div>
                                                    </div>
                                                </div>
