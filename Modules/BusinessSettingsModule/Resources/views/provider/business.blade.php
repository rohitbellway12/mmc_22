                                                ...
                                                <div class="col-xxl-3 col-lg-4">
                                                    <div class="d-flex flex-column gap-4 justify-content-center h-100">
                                                        <div class="bg-light rounded-10 p-3 p-sm-20 d-flex flex-column gap-20 w-100 h-100">
                                                            ...
                                                            <div class="upload_wrapper d-flex justify-content-center">
                                                                <div class="upload-file-new">
                                                                    <input type="file" name="logo" class="upload-file-new__input single_file_input"
                                                            ...
                                                            <p class="fs-10 mb-0 text-center">{{ translate('JPG,_JPEG_PNG_Gif_image_size_:_max_2_MB') }} <span
                                                        ...
                                                        <div class="bg-light rounded-10 p-3 p-sm-20 d-flex flex-column gap-20 w-100 h-100">
                                                            ...
                                                            <div class="upload_wrapper d-flex justify-content-center">
                                                                <div class="upload-file-new">
                                                                    <input type="file" name="cover_image" class="upload-file-new__input single_file_input"
                                                                           accept=".webp, .jpg, .jpeg, .png, .gif" value="">
