                                                        ...
                                                        <td>
                                                            @foreach ($withdrawalMethod['method_fields'] as $key => $methodField)
                                                                <span
                                                                    ...
                                                                    <b>{{ translate('Placeholder') }}:</b>
                                                                    {{ $methodField['placeholder'] ?? ($methodField['input_placeholder'] ?? '') }}
                                                                    |
                                                                    <b>{{ translate('Is Required') }}:</b>
                                                                    {{ $methodField['is_required'] ? translate('yes') : translate('no') }}
                                                                </span><br />
                                                            @endforeach
                                                        </td>
                                                        @can('withdraw_manage_status')
                                                            <td>
                                                                <label class="switcher">
                                                                    <input class="switcher_input route-alert-reload"
                                                                        ...
                                                                        type="checkbox"
                                                                        {{ $withdrawalMethod->is_active ? 'checked' : '' }}>
                                                            ...
                                                            <td>
                                                                <label class="switcher">
                                                                    <input class="switcher_input route-alert-reload"
                                                                        ...
                                                                        type="checkbox"
                                                                        {{ $withdrawalMethod->is_default ? 'checked' : '' }}>
                                                                    <span class="switcher_control"></span>
                                                                </label>
                                                            </td>
                                                        @endcan
