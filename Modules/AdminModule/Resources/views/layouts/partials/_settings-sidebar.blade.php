            ...
            <div class="switch-items">
                <div class="setting-box-wrap">
                    <div class="setting-box active light-mode">
                        <img src="{{ asset('public/assets/admin-module') }}/img/light-mode.png" width="36px"
                            alt="">
                    </div>
                ...
                <div class="setting-box-wrap">
                    <div class="setting-box dark-mode">
                        <img src="{{ asset('public/assets/admin-module') }}/img/dark-mode.png" width="36px"
                            alt="">
                    </div>
...
<!--        <button type="button"-->
<!--            class="p-0 m-0 border-0 shadow-none text-secondary bg-transparent easy-setup-dropdown_close"><span-->
<!--                class="border rounded-circle d-flex align-items-center justify-content-center w-24 h-24 fs-14"-->
...
<!--                    <img src="{{ asset('public/assets/provider-module') }}/img/icons/light-mode.svg" width="30"-->
<!--                        alt="{{ translate('provider-module') }}">-->
<!--                </div>-->
<!--                <div class="setting-box flex-grow-1 dark-mode">-->
<!--                    <img src="{{ asset('public/assets/provider-module') }}/img/icons/dark-mode.svg" width="30"-->
<!--                        alt="{{ translate('provider-module') }}">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
