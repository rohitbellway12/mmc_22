        ...
        <div class="user-profile media gap-3 align-items-center my-3">
            <div class="avatar">
                <img class="avatar-img rounded-circle aspect-square object-fit-cover"
                    src="{{ auth()->user()->profile_image_full_path }}" alt="{{ translate('profile_image') }}">
            </div>
            ...
            @can('booking_view')
                ...
                <li class="has-sub-item {{ request()->is('admin/booking/*') ? 'sub-menu-opened' : '' }}">
                    ...
                    <ul class="nav sub-menu">
                        ...
                        <li><a href="{{ route('admin.car.booking.list') }}"
                                class="{{ request()->is('admin/car/booking/*') ? 'active-menu' : '' }}"><span
                                    class="link-title">{{ translate('Car_Hire_Bookings') }}</span></a>
                        </li>
                    </ul>
                </li>
            @endcan
                ...
                <li>
                    <a href="{{ route('admin.business-settings.notification-channel', ['notification_type' => 'user']) }}"
                        ...
                        <span class="material-icons"
                            title="{{ translate('push_notification') }}">notifications_active</span>
            ...
            @canany(['category_add', 'category_view'])
                <li
                    ...
                    <ul class="nav sub-menu">
                        ...
                        <!--</li>-->
                        <li>
                            <a href="{{ route('admin.provider.category_questions.index') }}"
                                class="{{ request()->is('admin/provider/category-questions*') ? 'active-menu' : '' }}">
                                {{ translate('Standardized Category Questions') }}
                            </a>
                        </li>
                    </ul>
                </li>
...
{{--
            ...
            @canany(['business_view', 'subscription_package_view', 'subscriber_view', 'subscription_settings_view',
                'page_view', 'landing_view', 'error_logs_view', 'cron_job_view'])
                <li class="nav-category" title="{{ translate('business_setup') }}">{{ translate('business_setup') }}
                </li>
            @endcanany
...
--}}
            ...
            @canany(['addon_view', 'addon_add'])
                ...
                @if (count(config('addon_admin_routes')) > 0)
                    <li
                        class="has-sub-item {{ request()->is('admin/payment/configuration/*') || request()->is('admin/sms/configuration/*') ? 'sub-menu-opened' : '' }}">
                        <a href="#"
