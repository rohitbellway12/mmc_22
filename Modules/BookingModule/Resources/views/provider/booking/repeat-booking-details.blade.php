            ...
            <div class="pb-3 d-flex justify-content-between align-items-center gap-3 flex-wrap">
                ...
                <div class="d-flex flex-wrap flex-xxl-nowrap gap-3">
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        @endif
                        <a href="{{ route('provider.booking.full_repeat_invoice', [$booking->id]) }}"
                            ...
                            <div class="card-header shadow-none border-bottom">
                                <div
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span
                                            class="badge badge-{{ $booking->nextService['booking_status'] == 'ongoing'
                                                ? 'warning'
                                                : ($booking->nextService['booking_status'] == 'completed'
                                                    ? 'success'
                                                    : ($booking->nextService['booking_status'] == 'canceled'
                                                        ? 'danger'
                                                        : 'info')) }}">
                                    ...
                                    <a href="{{ route('provider.booking.repeat_single_details', [$booking->nextService['id'], 'web_page' => 'details']) }}"
                                        class="btn btn--secondary-two text-capitalize fw-semibold fz-14">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <button type="button"
                                            ...
                                            <span
                                                class="opacity-75">{{ date('d-M-Y h:ia', strtotime($booking->nextService['service_schedule'])) }}</span>
                                        </button>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex gap-30 justify-content-md-around mt-3 mt-md-0">
                                            <div>
                                                ...
                                                <h5 class="fz-14">
                                                    {{ with_currency_symbol($booking->nextService['total_booking_amount']) }}
                                                </h5>
                                            </div>
                                            <div class="border--start ps-30">
                                                ...
                                                <h5 class="fz-14">
                                                    <span
                                                        class="text-{{ $booking->nextService['is_paid'] ? 'success' : 'danger' }}"
                    ...
                    <div class="card mb-3">
                        <div class="card-header shadow-none border-bottom">
                            <div class="d-flex justify-content-between flex-wrap gap-3">
                                ...
                                <a href="{{ url()->current() }}?web_page=service_log"
                                    class="btn-link text-primary fw-semibold">{{ translate('View All Booking') }}</a>
                            </div>
                        </div>
                        <div class="card-body pb-5">
                            <div
                                ...
                                <div>
                                    ...
                                    @if ($booking->slotBooking && $booking->slotBooking->timeSlot)
                                        <p>
                                            <span>{{ translate('Slot') }} : </span>
                                            <span class="badge badge-info text-capitalize fw-semibold">
                                                {{ \Carbon\Carbon::parse($booking->slotBooking->timeSlot->start_time)->format('h:i A') }}
                                                -
                                                {{ \Carbon\Carbon::parse($booking->slotBooking->timeSlot->end_time)->format('h:i A') }}
                                            </span>
                                        </p>
                                    @endif
                                </div>
                            ...
                            @else
                                <div class="c1-light-bg radius-10">
                                    <div class="p-4 d-flex justify-content-center gap-3">
                                        <button type="button"
                                            class="btn btn-soft--danger g-2 max-w120 flex-grow-1 {{ env('APP_ENV') != 'demo' ? 'btn-reject-booking' : 'demo_check' }}"
                                    ...
                                    <div class="py-3 px-4">
                                        @if ($booking->service_location == 'provider')
                                            <div class="bg-warning p-3 rounded">
                                                <h5>{{ translate('The Customer will come to the your Location to receive the service') }}
                                                </h5>
                                            </div>
                                            <div class="mt-3">
                                        ...
                                        @else
                                            <div class="bg-warning p-3 rounded">
                                                <h5>{{ translate('You need to go to the Customer Location to provide the service') }}
                                                </h5>
                                            </div>
                                            <div class="mt-3">
                                                <h5 class="mb-1">{{ translate('Service Location') }}:</h5>
                                                ...
                                                <div class="p-2 rounded bg-white d-flex flex-column gap-1">
                                                    @if ($repeat['log_details'])
                                                        ...
                                                        <div class="d-flex gap-4 justify-content-end px-2">
                                                            <div>{{ 'Service Vat' }}:</div>
                                                            <div class="fw-bold">
                                                                {{ with_currency_symbol($repeat['total_tax_amount']) }}
                                                            </div>
                                                        </div>
                                                    @endif
                                                </div>
    ...
    <script>
            ...
            if (parseInt(booking_status) !== 0) {
                ...
                if (booking_status === 'canceled') {
                    update_booking_details(route,
                        ...
                        'booking_status',
                        booking_status,
                        '{{ translate('Are you sure you want to cancel the entire booking?') }}');
                } else {
        ...
        $("#serviceman_assign").change(function() {
            ...
            if (serviceman_id !== 'no_serviceman') {
                var route = '{{ route('provider.booking.serviceman_update', [$booking->id]) }}' +
                    '?serviceman_id=' +
                    serviceman_id;
        ...
        function update_booking_details(route, message, componentId, updatedValue, title =
