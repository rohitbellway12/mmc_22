                                            ...
                                            @if($booking->slotBooking && $booking->slotBooking->timeSlot)
                                                <div class="mt-1">
                                                    <span class="badge badge-info text-capitalize">
                                                        {{translate('Slot')}}: {{ \Carbon\Carbon::parse($booking->slotBooking->timeSlot->start_time)->format('h:i A') }} - {{ \Carbon\Carbon::parse($booking->slotBooking->timeSlot->end_time)->format('h:i A') }}
                                                    </span>
                                                </div>
                                            @endif
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        @if(isset($detail->service))
                                                            <div class="d-flex align-items-center gap-3">
                                                                @if(isset($detail->tyre) && !empty($detail->tyre->image_full_paths))
                                                                    <img width="50" height="50" class="rounded object-fit-cover"
                                                                         src="{{ $detail->tyre->image_full_paths[0] }}"
                                                                         alt="{{ $detail->tyre->model }}">
                                                                @endif
                                                                <div class="d-flex flex-column">
                                            ...
                                            <ul class="list-info">
                                                @if($booking->car_model)
                                                    <li>
                                                        ...
                                                        <p><strong>{{ translate('Car_Model') }}:</strong> {{ $booking->car_model }}</p>
                                                    </li>
                                                @endif
                                                @if($booking->car_manufacture_year)
                                                    <li>
                                                        <span class="material-icons">calendar_today</span>
                                                        <p><strong>{{ translate('Manufacture_Year') }}:</strong> {{ $booking->car_manufacture_year }}</p>
                                                    </li>
                                                @endif
                                                @if($booking->car_color)
                                                    <li>
                                                        <span class="material-icons">palette</span>
                                                        <p><strong>{{ translate('Car_Color') }}:</strong> {{ $booking->car_color }}</p>
                                                    </li>
                                                @endif
                                                @if($booking->car_registration_number)
                                                    <li>
                                                        <span class="material-icons">tag</span>
                                                        <p><strong>{{ translate('Registration_No') }}:</strong> {{ $booking->car_registration_number }}</p>
                                                    </li>
                                                @endif
                                                ...
                                                @if($booking->special_conditions)
                                                    <li>
                                                        ...
                                                        <p><strong>{{ translate('Special_Conditions') }}:</strong> {{ $booking->special_conditions }}</p>
                                                    </li>
                                                @endif
                                                @if($booking->notes)
                                                    <li>
                                                        <span class="material-icons">note</span>
                                                        <p><strong>{{ translate('Notes') }}:</strong> {{ $booking->notes }}</p>
                                                    </li>
                                                @endif
                                                @if($booking->postcode)
                                                    <li>
                                                        <span class="material-icons">pin_drop</span>
                                                        <p><strong>{{ translate('Postcode') }}:</strong> {{ $booking->postcode }}</p>
                                                    </li>
                                                @endif
