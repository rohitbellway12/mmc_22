                                            ...
                                            <form method="post"
                                                ...
                                                <div class="c1-light-bg p-4 rounded">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-2">
                                                        ...
                                                        <div class="form-check-inline">
                                                            <input
                                                                class="form-check-input deny-request booking-verification-status"
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center flex-xxl-nowrap gap-3 mb-4">
                ...
                @if (
                    $booking->booking_offline_payments->isNotEmpty() &&
                        ...
                        $booking?->booking_offline_payments?->first()?->payment_status != 'approved')
                    <div class="border border-danger-light bg-soft-danger rounded py-3 px-3 text-dark">
                                        ...
                                        <h5 class="d-flex gap-1 flex-wrap align-items-center">
                                            ...
                                            <div id="service_schedule__span">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    @if ($booking?->schedule_histories->count() > 1)
                                                        <button class="btn btn-sm btn-outline-primary fz-10 py-0 px-1"
                                                            type="button" data-bs-toggle="collapse"
                                                            data-bs-target="#scheduleLog" aria-expanded="false"
                                                            aria-controls="scheduleLog">
                                                            {{ translate('View Log') }}
                                                        </button>
                                                    @endif
                                                </div>

                                                <div class="collapse" id="scheduleLog">
                                        ...
                                        <table class="table-md title-color align-right w-100">
                                            <tbody>
                                                ...
                                                @if ($booking->total_referral_discount_amount > 0)
                                                    <tr>
                                                        <td class="text-capitalize">{{ translate('Referral Discount') }}
                                                        </td>
                                                        <td class="text--end pe--4">
                                ...
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control h-45">
                                    ...
                                    <div class="on-off-toggle">
                                        <input class="on-off-toggle__input switcher_input"
                                            ...
                                            {{ $booking['is_paid'] ? 'checked' : '' }} type="checkbox" id="payment_status"
                                            @if (
                                                $booking['payment_method'] == 'cash_after_service' &&
                                                    $booking->is_verified == '2' &&
                                                    $booking->total_booking_amount >= $maxBookingAmount) disabled @endif>
                                    ...
                                    <div class="card text-center">
                                        <div class="card-header">
                                            <h5 class="font-weight-bold">
                                                {{ translate('Verification of Offline Payment') }}</h5>
                                        </div>
                                        <div class="card-body">
                                            @if ($booking->booking_offline_payments->isNotEmpty())
                                                ...
                                                @if ($offlinePaymentNote != '')
                                                    <div class="badge-warning px-3 py-3 rounded title-color mt-3">
                                                        <span>
                                                            <span class="fw-semibold"> # {{ translate('Payment Note') }}:
                                                            </span>
                                                            {{ $offlinePaymentNote }}
                                                        </span>
                                                    </div>
                                                ...
                                                @endif
                                            @else
                                                <img src="{{ asset('public/assets/admin-module/img/offline-payment.png') }}"
                                                    alt="Payment Icon" class="mb-3">
                                                <p class="text-muted">
                                                    {{ translate('Customer did not submit any payment information yet') }}
                                                </p>
                                                @if ($booking['booking_status'] != 'canceled')
                                                    <div class="d-flex flex-column gap-2 mt-4">
                                                        <button
                            ...
                            <div class="py-3 d-flex flex-column gap-3 mb-2">
                                ...
                                <div class="c1-light-bg radius-10">
                                    <div class="border-bottom d-flex align-items-center justify-content-between gap-2 py-3 px-4 mb-2 cursor-pointer section-toggle"
                                        data-bs-toggle="collapse" data-bs-target="#serviceLocationContent">
                                    ...
                                    <div class="collapse" id="serviceLocationContent">
                                        <div class="py-3 px-4">
                                                    ...
                                                    @if ($booking->provider_id != null)
                                                        @if ($booking->provider)
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <p>{{ Str::limit($booking?->provider?->company_address ?? translate('not_available'), 100) }}
                                                                </p>
                                ...
                                <div class="c1-light-bg radius-10">
                                    <div class="border-bottom d-flex align-items-center justify-content-between gap-2 py-3 px-4 mb-2 cursor-pointer section-toggle"
                                        data-bs-toggle="collapse" data-bs-target="#customerInfoContent"
                                        aria-expanded="true">
                                        <h4 class="d-flex align-items-center gap-2 mb-0">
                                                        ...
                                                        @if (!$booking?->is_guest)
                                                            <li>
                                                                <div
                                                                    ...
                                                                    <form
                                                                        action="{{ route('admin.chat.create-channel') }}"
                                                                        method="post"
                                ...
                                <div class="c1-light-bg radius-10 provider-information">
                                    <div class="border-bottom d-flex align-items-center justify-content-between gap-2 py-3 px-4 mb-2 cursor-pointer section-toggle"
                                        data-bs-toggle="collapse" data-bs-target="#providerInfoContent">
                                        <h4 class="d-flex align-items-center gap-2 mb-0">
                                            <span class="material-icons title-color">person</span>
                                    ...
                                    <div class="collapse" id="providerInfoContent">
                                        @if (isset($booking->provider))
                                            <div class="py-3 px-4">
                                                <div class="media gap-2 flex-wrap">
                                                    <img width="58" height="58"
                                ...
                                @if ($booking->special_conditions || $booking->notes || $booking->postcode || $booking->evidence_photos)
                                    <div class="c1-light-bg radius-10 mt-3">
                                        <div class="border-bottom d-flex align-items-center justify-content-between gap-2 py-3 px-4 mb-2 cursor-pointer section-toggle"
                                            ...
                                            <h4 class="d-flex align-items-center gap-2 mb-0">
                                                <span class="material-icons title-color">directions_car</span>
                                                {{ translate('Vehicle_&_Booking_Details') }}
                                            </h4>
                                            <span class="material-icons toggle-icon">expand_more</span>
                                        </div>

                                        <div class="collapse" id="vehicleDetailsContent">
                                            <div class="py-3 px-4">
                                                <ul class="list-info">
                                                    @if ($booking->car_model)
                                                        <li>
                                                            <span class="material-icons">directions_car</span>
                                                            <p><strong>{{ translate('Car_Model') }}:</strong>
                                                                {{ $booking->car_model }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($booking->car_manufacture_year)
                                                        <li>
                                                            <span class="material-icons">calendar_today</span>
                                                            <p><strong>{{ translate('Manufacture_Year') }}:</strong>
                                                                {{ $booking->car_manufacture_year }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($booking->car_color)
                                                        <li>
                                                            <span class="material-icons">palette</span>
                                                            <p><strong>{{ translate('Car_Color') }}:</strong>
                                                                {{ $booking->car_color }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($booking->car_registration_number)
                                                        <li>
                                                            <span class="material-icons">tag</span>
                                                            <p><strong>{{ translate('Registration_No') }}:</strong>
                                                                {{ $booking->car_registration_number }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($booking->booking_type)
                                                        <li>
                                                            <span class="material-icons">info</span>
                                                            <p><strong>{{ translate('Booking_Type') }}:</strong>
                                                    ...
                                                    @if ($booking->special_conditions)
                                                        <li>
                                                            ...
                                                            <p><strong>{{ translate('Special_Conditions') }}:</strong>
                                                                {{ $booking->special_conditions }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($booking->notes)
                                                        <li>
                                                    ...
                                                    @if ($booking->postcode)
                                                        <li>
                                                            ...
                                                            <p><strong>{{ translate('Postcode') }}:</strong>
                                                                {{ $booking->postcode }}</p>
                                                        </li>
                                                    @endif
                                                    @if ($booking->evidence_photos)
                                                        <li class="flex-column align-items-start mt-2">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <span class="material-icons">photo_library</span>
                                                                <p><strong>{{ translate('Car_Images') }}:</strong></p>
                                                            </div>
...
{{--
                                <div class="c1-light-bg radius-10 serviceman-information">
                                    <div class="border-bottom d-flex align-items-center justify-content-between gap-2 py-3 px-4 mb-2 cursor-pointer section-toggle"
                                        data-bs-toggle="collapse" data-bs-target="#servicemanInfoContent">
                                        <h4 class="d-flex align-items-center gap-2 mb-0">
                                            <span class="material-icons title-color">person</span>
                                    ...
                                    <div class="collapse" id="servicemanInfoContent">
                                        @if (isset($booking->serviceman))
                                            <div class="py-3 px-4">
                                                <div class="media gap-2 flex-wrap">
                                                    <img width="58" height="58"
                                        ...
                                        @else
                                            ...
                                            <div class="text-center pb-4">
                                                <button class="btn btn--primary" data-bs-target="#servicemanModal"
                                                    data-bs-toggle="modal"
                ...
                <div class="modal-body pt-5 p-md-5">
                    ...
                    <div class="d-flex justify-content-center mb-4">
                        <img width="75" height="75"
                            src="{{ asset('public/assets/admin-module/img/icons/info-round.svg') }}"
                            class="rounded-circle" alt="">
                    </div>

                    <h3 class="text-start mb-1 fw-medium text-center">{{ translate('Are you sure you want to deny?') }}
                    </h3>
                    <p class="text-start fs-12 fw-medium text-muted text-center">
                        {{ translate('Please insert the deny note for this payment request') }}</p>
                    <form method="post"
                        action="{{ route('admin.booking.offline-payment.verify', ['booking_id' => $booking->id, 'payment_status' => 'denied']) }}">
                        @csrf
                        <div class="form-floating">
                            <textarea class="form-control h-69px" placeholder="{{ translate('Type here your note') }}" name="note"
                                id="add-your-note" maxlength="255" required></textarea>
...
@push('script')
    <script>
        ...
        $(".change-booking-status").on('click', function() {
            ...
            var route = '{{ route('admin.booking.status_update', [$booking->id]) }}' + '?booking_status=' +
                booking_status;
            update_booking_details(route, '{{ translate('want_to_cancel_booking_status') }}', 'booking_status',
                booking_status);
        });
        ...
        $(".switch-to-cash-after-service").on('click', function() {
            ...
            var route = '{{ route('admin.booking.switch-payment-method', [$booking->id]) }}' +
                '?payment_method=' + payment_method;
            update_booking_details(route,
                '{{ translate('want_to_switch_payment_method_to_cash_after_service') }}', 'payment_method',
                payment_method);
        });
                    ...
                    $.get({
                        ...
                        success: function(data) {
                            ...
                            if (componentId === 'booking_status' || componentId === 'payment_status' ||
                                ...
                                'serviceman_assign' || componentId === 'payment_method') {
                                location.reload();
                            }
                        },
                        complete: function() {},
            ...
            function addressMap() {
                ...
                google.maps.event.addListener(map, 'click', function(mapsMouseEvent) {
                    ...
                    geocoder.geocode({
                        ...
                        if (status == google.maps.GeocoderStatus.OK) {
                            if (results[1]) {
                                document.getElementById('address_address').value = results[1]
                                    .formatted_address;
                            }
                        }
                    });
                ...
                searchBox.addListener("places_changed", () => {
                    ...
                    places.forEach((place) => {
                        ...
                        google.maps.event.addListener(mrkr, "click", function(event) {
                            document.getElementById('address_latitude').value = this
                                .position.lat();
                            document.getElementById('address_longitude').value = this
                                .position.lng();
                        });
    ...
    <script>
            ...
            $(document).on('keyup', '.search-form-input1', function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        if (xhr.status === 419) {
                            toastr.error(
                                '{{ translate('Session expired, please refresh the page.') }}'
                            );
                        } else {
                            toastr.error('{{ translate('Failed to load') }}');
                        }
        ...
        $(document).ready(function() {
            $("#customerAddressModalSubmit").on("submit", function(e) {
                ...
                let contactPersonName = customerAddressModal.find("input[name='contact_person_name']")
                    .val();
                let contactPersonNumber = customerAddressModal.find("input[name='contact_person_number']")
                    .val();
                ...
                $('#customer_service_location').removeClass(
                    'text-danger'); // Update the customer service location
                $('#customer_service_location').text(address); // Update the customer service location
                $('.customer-address-update-btn').removeAttr(
                    'disabled'); // Update the customer service location update button
        ...
        $(".customer-address-reset-btn").on("click", function(e) {
            ...
            $("input[name='contact_person_number']").val(
