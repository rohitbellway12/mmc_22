                    ...
                    <div class="row">
                        <div class="col">
                            <a target="_blank" href="#">
                                ...
                                <img width="200" src="{{ $logo }}" data-holder-rendered="true" />
                            </a>
                        </div>
                ...
                <main>
                    <div class="row contacts">
                        <div class="col invoice-to">
                            ...
                            <h2 class="to">{{ $booking->customer->first_name . ' ' . $booking->customer->last_name }}
                            </h2>
                            <div class="address">
                                {{ $booking->service_address->address ?? translate('address_not_available') }}</div>
                            <div class="email"><a
