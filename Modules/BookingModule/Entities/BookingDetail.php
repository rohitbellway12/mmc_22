...
class BookingDetail extends Model
{
    ...
    protected $fillable = ['booking_id', 'service_id', 'tyre_id', 'variant_key', 'service_cost', 'quantity', 'discount_amount', 'tax_amount', 'total_cost', 'campaign_discount_amount', 'overall_coupon_discount_amount'];
